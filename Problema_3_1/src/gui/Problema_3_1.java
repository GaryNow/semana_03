...
public class Problema_3_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		Factura a = new Factura("111","SODIMAC",50,100);
		listado(a);
		Factura b = new Factura("112","XYZ SAC");
		listado(b);
		Factura c = new Factura();
		listado(c);
		
		imprimir("------------------------------------");
		imprimir("Cantidad de Facturas:  " + Factura.getCantidadFacturas());
		imprimir("Importe acumulado:  " + Factura.getSumaImportes());
		imprimir("Entidad:  " + Factura.getClase());
		imprimir("------------------------------------");
		imprimir();
	}
	...
	void listado(Factura x) {
		...
		imprimir("Precio:  " + x.getPrecioUnitario());
