...
public class Propuesto_3_3 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		Consultor c1 = new Consultor(111,"Now",40,80);
		listado(c1);
		Consultor c2 = new Consultor(222,"Gary",35);
		listado(c2);
		Consultor c3 = new Consultor();
		listado(c3);
		
		imprimir("------------------------------------");
		imprimir("Cantidad de Consultores\t:" + Consultor.getCantidadConsultor());
		imprimir("Suma de Sueldos Netos\t:" + Consultor.getSumaSueldosNetos());
		imprimir("Valor de Desc. EPS\t:" + Consultor.EPS);
		imprimir("Valor de Desc. AFP\t:" + Consultor.AFP);
		imprimir("------------------------------------");
		imprimir();
	}
	...
	void listado(Consultor x) {
		...
		imprimir("Tarifa x Hora\t\t:" + x.getTarifaPorhora());
